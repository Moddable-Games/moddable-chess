...
const THEMES = {
  ...
  transparent: { light: 'rgba(255, 255, 255, 0.05)', dark: 'rgba(255, 255, 255, 0.1)', highlight: 'rgba(111, 181, 255, 0.25)', lastMove: 'rgba(111, 181, 255, 0.15)', dot: 'rgba(255, 255, 255, 0.3)', ring: 'rgba(255, 255, 255, 0.35)', border: 'rgba(255, 255, 255, 0.1)', label: 'Transparent' },
};
