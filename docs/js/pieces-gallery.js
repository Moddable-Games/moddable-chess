...
const MCE_SETS = [
  {
    ...
    license: 'MIT',
    recolorable: true,
    notes: '34 pieces: standard 6 + 11 fairy types × 2 colours. The active piece set used by all variants.',
    pieces: [
    { file: 'bA.svg', char: 'a', color: 'b', name: 'Archbishop' },
    { file: 'bB.svg', char: 'b', color: 'b', name: 'Bishop' },
    { file: 'bC.svg', char: 'c', color: 'b', name: 'Chancellor' },
...
const CHAR_NAMES = {
  ...
  a:'Archbishop', c:'Chancellor', m:'Maharaja', f:'Fers', g:'Khon',
  e:'Elephant', y:'Yurt', l:'Lancer', h:'Archer', w:'Kheshig', i:'Sit', s:'Sage',
